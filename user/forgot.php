            ...
            <div style="padding: 50px;" class="col-md-6">
                ...
                <div class="form-outline">
                    <form action="" method="post">
                        <p style="margin-top:30px; color: #7788F4; font-size: 10pt;">Please provide your valid email address</p>
                        ...
                        <input style="margin-top:20px; font-size:9pt; padding:10px; width:100%; background-color: #7788F4; border-color: #7788F4;" name="doctor_login" type="submit" value="Send OTP" class="btn btn-primary">
                    </form>
                </div>
            </div>
        </div>
