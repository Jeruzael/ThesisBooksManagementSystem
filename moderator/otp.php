            ...
            <div style="padding: 50px;" class="col-md-6">
                ...
                <div class="form-outline">
                    <form action="otp.php" method="post">
                        ...
                        <input style="margin-top:20px; font-size: 22px; line-height: 33px; padding:10px; width:100%; background-color: <?php echo $fetchColor['color_5']?>; border-color: <?php echo $fetchColor['color_5']?>;" name="moderatorVerify" type="submit" value="Verify" class="btn btn-primary">
                    </form>
                </div>
            </div>
