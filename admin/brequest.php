                ...
                <table style="width:100%; border-collapse:collapse; margin:25px 0; font-size:0.9em; border-radius:5px 5px 0 0;min-width: 1000px;">
                    ...
                    <tbody>
                        <?php
                            ...
                            $dataQuery = "SELECT *, DATE_FORMAT(requestStamp, '%M %d, %Y') as borrowDate FROM thesisrequest INNER JOIN thesisLibrary ON thesisrequest.requestBookId = thesisLibrary.bookId INNER JOIN teamsuser ON thesisrequest.requesterId = teamsuser.userId where thesisLibrary.bookStatus = 'available' order by requestId asc LIMIT $offset, $total_records_per_page";
