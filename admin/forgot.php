    ...
    <body>
        ...
        <div class="container-fluid row signin">
            ...
            <div style="padding: 50px;" class="col-md-6">
                ...
                <h3 style="font-weight: 700; margin-top: 20%;">Forgot Password</h3>
                <div class="form-outline">
                    <form action="" method="post">
                        <p style="margin-top:30px; color: #FD8978; font-size: 10pt;">Please provide your valid email address</p>
                        ...
                        <input style="margin-top:20px; font-size:9pt; padding:10px; width:100%; background-color: #FD8978; border-color: #FD8978;" name="doctor_login" type="submit" value="Send OTP" class="btn btn-primary">
                    </form>
                </div>
            </div>
